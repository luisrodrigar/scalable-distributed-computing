...
For this we have created a new variable `pu_hour` that corresponds to the variable `tpep_pickup_datetime` in hours, then we have divided this new variable into four groups: 
